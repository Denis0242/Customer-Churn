...
Rather than focusing only on prediction accuracy, the goal is to uncover why users churn, which behaviors signal risk early, and how product teams can intervene effectively.

The analysis mirrors how a Product Data Scientist partners with Product Managers and stakeholders to support retention, engagement, and revenue decisions.
